...
public class Stopwords {
	...
	public Stopwords() {
		...
		try {
			String sCurrentLine;
			//BufferedReader br = new BufferedReader(new FileReader("Y:/Documents/MyDoc/MyDocCloneDrive/HIIT/Work/Projects/MailVis/code/Email/EmailSearch/src/stopwords/stopwords.txt"));
			BufferedReader br = new BufferedReader(new FileReader("/Users/chenhe/eclipse-workspace/EmailSearch/src/stopwords/stopwords.txt"));
